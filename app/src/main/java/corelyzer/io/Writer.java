...
public class Writer {
	...
	public static void write(final DocumentImpl doc, final OutputStream ostream) {
		...
		Writer writer = null;
		/*
		 * boolean namespaces = DEFAULT_NAMESPACES; boolean validation =
		 * DEFAULT_VALIDATION; boolean externalDTD = DEFAULT_LOAD_EXTERNAL_DTD;
		 * boolean schemaValidation = DEFAULT_SCHEMA_VALIDATION; boolean
		 * schemaFullChecking = DEFAULT_SCHEMA_FULL_CHECKING; boolean
		 * honourAllSchemaLocations = DEFAULT_HONOUR_ALL_SCHEMA_LOCATIONS;
		 * boolean validateAnnotations = DEFAULT_VALIDATE_ANNOTATIONS; boolean
		 * generateSyntheticAnnotations =
		 * DEFAULT_GENERATE_SYNTHETIC_ANNOTATIONS; boolean dynamicValidation =
		 * DEFAULT_DYNAMIC_VALIDATION; boolean xincludeProcessing =
		 * DEFAULT_XINCLUDE; boolean xincludeFixupBaseURIs =
		 * DEFAULT_XINCLUDE_FIXUP_BASE_URIS; boolean xincludeFixupLanguage =
	...
	public Writer(final boolean canonical) {
