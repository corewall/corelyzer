...
public class CRGraphDialog extends JFrame {
	...
	public static void main(final String[] args) {
		...
		CRGraphDialog dialog = new CRGraphDialog();
	...
	private void init(Vector<WellLogDataSet> datasets) {
	...
	private void createListeners() {
		...
		fieldsTable.getModel().addTableModelListener( new TableModelListener() {
			public void tableChanged( TableModelEvent event ) {	onFieldsTableChanged( event ); }
		});
		
		fieldsTable.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
			public void valueChanged(final ListSelectionEvent event) { onFieldsListChanged(); }
		});

		scaleMinText.addFocusListener(new FocusListener() {
			public void focusGained(final FocusEvent event) { }
			public void focusLost(final FocusEvent event) {	onScaleMinTextLostFocus(); }
		});

		scaleMaxText.addFocusListener(new FocusListener() {
			public void focusGained(final FocusEvent event) { }
			public void focusLost(final FocusEvent event) { onScaleMaxTextLostFocus(); }
		});
		...
		collapseGraphs.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent event) { collapseChecked(); }
		});

		overlayGraphs.setSelected(SceneGraph.getGraphsOverlay());
		overlayGraphs.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent event) { overlayChecked(); }
		});

		enableOverlayCheckbox(); // init overlay checkbox to proper state

		// Because selecting all sections can be slow for large datasets, do so only
		// after Graph dialog has opened and fully drawn all components.
