...
public class LineNumberedPaper extends JTextArea {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7527894618746768989L;
	...
	public static void main(final String[] args) {
		...
		int[] justified = { LineNumberedBorder.LEFT_JUSTIFY, LineNumberedBorder.RIGHT_JUSTIFY };

		String[] labels = { "Left Justified", "Right Justified" };
	...
	public LineNumberedPaper(final int rows, final int cols) {
		super(rows, cols);
		setOpaque(false);
	 ...
	 */
	private String padLabel(final int lineNumber, final int length, final boolean addSpace) {
...
} // corelyzer.ui.LineNumberedPaper
