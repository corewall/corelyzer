...
public class ProjectDescriptionDialog extends JDialog {
	/**
	 * 
	 */
	private static final long serialVersionUID = 5826489276000604685L;

	public static void main(final String[] args) {
		ProjectDescriptionDialog dialog = new ProjectDescriptionDialog(new JDialog());
		dialog.pack();
	...
	public ProjectDescriptionDialog(final JDialog owner) {
		super(owner);
