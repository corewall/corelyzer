 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_corelyzer_graphics_SceneGraph_clearEditSectionTie
  (JNIEnv *, jclass);
 ...
 * Signature: (FFII)I
 */
JNIEXPORT jint JNICALL Java_corelyzer_graphics_SceneGraph_commitSectionTie
 ...
 * Signature: (IZ)V
 */
JNIEXPORT void JNICALL Java_corelyzer_graphics_SceneGraph_selectSectionTie
  (JNIEnv *, jclass, jint, jboolean);
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_corelyzer_graphics_SceneGraph_deselectAllSectionTies
  (JNIEnv *, jclass);
 ...
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_corelyzer_graphics_SceneGraph_getSectionTieASection
  (JNIEnv *, jclass, jint);
 ...
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_corelyzer_graphics_SceneGraph_getSectionTieBSection
  (JNIEnv *, jclass, jint);
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_corelyzer_graphics_SceneGraph_deleteSectionTiesOnTrack
  (JNIEnv *, jclass, jint);
